...
def difference(x):
    ...
    difference = []
    for i in range(x.shape[0]):
        name = "dump.A1B3_thin_film_with_wall_XN_100_10_" + str(iterations - i)
...
if __name__ == "__main__":
    ...
    node0 = ovito.io.import_file("dump.A1B3_thin_film_with_wall_XN_100__25", multiple_frames=True)
    ...
    optimizer = ps.single.LocalBestPSO(swarmsize, dimension, options, bound)
